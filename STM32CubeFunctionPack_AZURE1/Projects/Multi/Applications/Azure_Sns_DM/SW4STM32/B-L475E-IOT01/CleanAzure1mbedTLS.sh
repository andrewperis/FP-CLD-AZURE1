...
echo "/******************************************/"
${OpenOCD_CMD} -c "program ../../../../../../Utilities/BootLoader/B-L475E-IOT01/BootLoaderL4.bin 0x08000000 exit" -c "shutdown"
echo "/******************************************/"
echo "          Install Azure1"
echo "/******************************************/"
${OpenOCD_CMD} -c "program ./B-L475E-IOT01/Release/Azure_Sns_DM.bin 0x08004000 exit" -c "shutdown"
echo "/******************************************/"
echo "    Dump Azure1+ BootLoader"
echo "/******************************************/"

# 16384==0x400
SizeBinBL=`ls -l ./B-L475E-IOT01/Release/Azure_Sns_DM.bin | awk '{print $5+16384};'`
${OpenOCD_CMD} -c "init" \
			   -c "reset halt" \
			   -c "sleep 100" \
			   -c "wait_halt 2" \
			   -c "dump_image ./B-L475E-IOT01/Release/Azure_Sns_DM_BL.bin 0x08000000 ${SizeBinBL}" \
			   -c "reset halt" \
			   -c "shutdown"
